...
class Gameplay
  ...
  def place_computers_ships
    ...
    if @game_board.valid_placement?(@submarine, computer_place_sub_coordinate.flatten) == true
    ...
    binding.pry
      ...
      #return @game_board.place(@cruiser, [choices.sample, choices.sample, choices.sample])
